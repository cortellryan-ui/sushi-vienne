...
/**
 * Menu côté ADMIN : TOUTES les catégories (actives ou non) et TOUS les plats
 * (disponibles ou non), triés par display_order. Réservé à l'espace admin.
 */
export async function getAdminMenu(): Promise<MenuSection[]> {
